...
const errorMssgs = {
    ...
    loginPassword: {
        valueMissing: "El campo mensaje no puede estar vacío",
        patternMismatch: "Contraseña debe contener mínimo --- y ___"
    },
    /*--------------------------------------------------*/
    url: {
    ...
    category: {
        ...
        patternMismatch: "Categoría debe contener mínimo 5 caracteres y máximo 20"
    },
    product: {
    ...
    price: {
        ...
        patternMismatch: "Precio no debe contener caracteres adicionales. Precio no válido!"
    },
    description: {
